...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let quizStarted = false; let rightAnswersTotal = 0; let maxTimeForAnswer = 11; let remainedTimerSeconds = maxTimeForAnswer;
            ...
            if (questionIndex < 2) {
                ...
                for (let i = 0; i < 4; i++) {
                    ...
                    if (i === rightAnswerIndex) {
                        ...
                        answerVariants[i].innerText = wrongAnswers[wrongAnswersIndex]; wrongAnswersIndex += 1;
                    }
                }
            }
        } else {
